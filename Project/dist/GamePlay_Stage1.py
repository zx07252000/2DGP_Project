...
def update():
    ...
    if Boss_Hp<1:
        game_world.remove_object(Stage1_enemy_Cloud)
        game_world.remove_object(Stage1_enemy_Sword)
        game_world.remove_object(Stage1_enemy_Chicken)
        game_world.remove_object(Stage1_boss)
        game_world.remove_object(CharacterMeiMei)
        game_world.remove_object(Stage1screen_HP_100)
        game_world.remove_object(Stage1screen_HP_70)
        game_world.remove_object(Stage1screen_HP_30)
